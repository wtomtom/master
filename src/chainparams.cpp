...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000003af98154d7d0136a61b9eaaf416d57da9bb497dbb152f2caf9a7096ea33"));
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "Vsync test masternode";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1521304879;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20775845;
        hashGenesisBlock = genesis.GetHash();
		
        assert(hashGenesisBlock == uint256("0x000003af98154d7d0136a61b9eaaf416d57da9bb497dbb152f2caf9a7096ea33"));
        assert(genesis.hashMerkleRoot == uint256("0x107a1d1cf9241372529027db1b8f4e6a61ddd803176e69180e2634fb75376477"));
