...
In order to support loading of multiple wallets in vsync-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vsync.cpp.
...
Changes to vsync.cpp
----------------------
vsync.cpp is the entry point into vsync-qt, and as such, will require some minor modifications to provide hooks for
